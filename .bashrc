...
export OSH='/home/faceyneck/.oh-my-bash'
...
# Alias for Local WordPress environment
# alias local='TMPDIR=$HOME/tmp /opt/Local/Local'


# Alias for Ranger, so that it exits to the directory I end up at:
